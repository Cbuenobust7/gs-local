...
class WP_E_Setting extends WP_E_Model {
    ...
    public function esig_license_expired() {
        ...
        if (!is_wp_error($request)) {
            ...
            $expiredLicenseStatus  = esigget('license',$request);
            set_transient('esig-license-check', $expiredLicenseStatus, 12 * HOUR_IN_SECONDS);
            if ($expiredLicenseStatus == "expired") {

                return true;
            }
            if ($expiredLicenseStatus == "disabled") {
