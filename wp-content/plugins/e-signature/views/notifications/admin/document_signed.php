												...
												<tbody>
													<tr>
														<td style="background-color:#ffffff;border:1px solid #ccc;padding:15px" bgcolor="FFFFFF">
															...
															<p style="line-height:1.4em;font-size:14px;margin:10px 0px">
																Hi <?php echo $data['owner_first_name']; ?>,<br>
																...
																<table cellspacing="0" cellpadding="0">
																	<tr>  
																		<td align="center" width="200" height="50" bgcolor="<?php echo $data['background_color']; ?>" style="color: #ffffff; display: block;">
																			<a href="<?php echo $data['view_url']; ?>" style="font-size:14px; font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block"><span style="color: #ffffff;"><?php _e('View Signed Document','esig'); ?></span></a>
																		</td>   
																	</tr> 
																</table>
