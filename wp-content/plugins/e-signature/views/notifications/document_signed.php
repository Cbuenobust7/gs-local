												...
												<tbody>
													<tr>
														<td style="background-color:#f7fafc;padding:8px 10px;border:1px solid #ccc;color:#444;font-weight:bold;margin-bottom:10px;text-align:center" bgcolor="#F7FAFC">
															<?php _e('Document has been signed','esig') ; ?>
														</td>
													</tr>
												</tbody>
											</table>
														...
														<td style="background-color:#ffffff;border:1px solid #ccc;padding:15px;" bgcolor="FFFFFF">
															...
															<p style="line-height:1.4em;font-size:14px;margin:10px 0px"> 
																<span style="color:#8c8c8c">
																	<?php _e('From:','esig');?><?php echo $data['sender']; ?> (<a href="mailto:<?php echo $data['owner_email']; ?>" target="_blank"><?php echo $data['owner_email']; ?></a>) 
																</span> 
															</p>
															...
															<p style="line-height:1.4em;font-size:14px;font-family:sans-serif;margin:10px 0px">
																<?php _e('Hi','esig'); ?> <?php echo $data['signer_name']; ?>,<br>
																<?php $custom_message = apply_filters('esig_signer_confirmation_custom_message','',$document_checksum=$data['document_checksum']); echo $custom_message; ?> <br>
																<?php _e('All signees have signed this document.','esig'); ?><br>
																<?php _e(' Audit Trail Serial#:','esig');?> <?php echo $data['document_id']; ?>
															</p>
															<hr style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
															<div style="margin:20px 0px 20px 0px">
																...
																<table cellspacing="0" cellpadding="0"> 
																	<tr>   
																		<td align="center" width="200" height="50" bgcolor="<?php echo $data['background_color']; ?>" style="color: #ffffff; display: block;">
																			<a href="<?php echo $data['view_url']; ?>" style="font-size:14px;font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block">
																				<span style="color: #ffffff;"><?php _e('View Signed Document','esig'); ?></span>
																			</a>
																		</td>   
																	</tr> 
																</table>
						...
						<tr style="border-collapse:collapse">
							<td style="font-family:'Helvetica Neue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse" align="center" bgcolor="#cccccc">
								<table style="margin-top:20px" border="0" cellpadding="20" cellspacing="0" width="100%"> 
									<tbody> 
										<tr style="border-collapse:collapse"> 
											<td style="padding:0px 12px 0px 0px;vertical-align:top;font-family:'Helvetica Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555" align="center"> 
												<br><a href="#" target="_blank"><img src="<?php echo $data['assets_dir']; ?>/images/verified-email.jpg" alt="WP E-Signature" border="0" style="width: 175px;margin-top: -8px;" class="emailClass" height="69" width="200">
											</td>
										</tr>
									</tbody>               
								</table>             
