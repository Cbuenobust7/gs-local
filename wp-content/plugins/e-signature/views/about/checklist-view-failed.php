<div id="installation-check-fail" class="installation-check-fail">
    ...
    <div class='head-check'>
      ...
      <div id ="error-show" class ="check-fail">
        ...
        <?php }
         ...
         <div class="failed-check" > We recommend trying one of the methods  <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/article/increase-memory-limit/" target="_blank"> in this helpful article </a> to increase your memory limit and improve PDF generation.</div>
        ...
        <?php }
         if(!WP_E_Addon::is_dir_writable()){  $is_esig_system_error = true;  ?>
          <div class="checklist-failed"> <span class="esig-icon-exit checklist-exit-icon"> </span><b><?php _e("Assets/temps/ directory permission set to be writable","esig");?></b></div>
    ...
    <div align="center"><button id="esig-system-checklist-retry" class="retry-checking"><b>Retry</b></button></div>
