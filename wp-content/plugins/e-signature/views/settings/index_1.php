    		...
    		<td>
  			...
  			<div id="tabs-1">
					...
					<div class="signature-wrapper">
						...
						<?php _e('I agree this is a legal representation of my signature for all purposes just the same as a pen-and-paper signature','esig'); ?>
		...
		<tr>	
			...
			<td>
				...
				<div id="esig-confirm-dialog" style="display:none;">
					...
					<div class="esig-confirm-dialog-content"><?php _e('Handing over Super-Admin ownership is serious business. Once you assign <span id="esig_selected_admin"> </span>as super admin you will no longer be able to send and preview documents unless you have the Additional E-Signature Roles Add-On. ', 'esig' ); ?>
