...
<?php _e('This is an optional settings page and is not required for WP E-Signature to work. 
The E-Signature Advanced Email Settings will only affect emails sent from WP E-Signature and will not affect your overall WordPress site email settings.<br><br>
Sending from an SMTP plugin is another excellent option for sending E-Signature emails. If you are currently experiencing issues sending emails,  <a href="https://wordpress.org/plugins/wp-mail-smtp/" target="_blank">WP Mail SMTP</a> is another (free) third-party option (which we recommend exploring). ', 'esig'); ?> 
        </div>
