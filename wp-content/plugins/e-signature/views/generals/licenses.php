...
<table class="form-table">
	<tbody>
       ...
       if(isset($result->license) && $result->license !='valid' && $result->license !== 'inactive') { ?>

       <p><h3 class="esig-activate-license esign-feedback-alert"><span class="esig-icon-esig-alert"></span> <?php
        Esign_licenses::esig_super_admin(true); ?>, <?php _e('You will need to activate your license to get started!','esig');?></h3></p>
           ...
           if(isset($result->license) && $result->license == 'valid' &&  $result->license_type != 'business-license')
           {
        ...
        <span class="esig-icon-chevron-right"></span>
        </div>
