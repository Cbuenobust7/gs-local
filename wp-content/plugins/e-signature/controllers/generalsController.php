...
class WP_E_generalsController extends WP_E_appController {
    ...
    public function misc() {
        if (isset($_POST['misc-submit'])) {
            ...
            $this->view->setAlert(array('type' => 'alert e-sign-alert esig-updated', 'title' => '', 'message' => __('<strong>Well done</strong> : Your E-Signature settings have been updated.', 'esig')));
        ...
        if ($this->settings->get_generic("esign_avatars_display")) {
            $esign_avatars_display = "checked";
        } else {
            $esign_avatars_display = "";
        }
        ...
        $template_data = array(
            ...
            "esign_avatars_display" => $esign_avatars_display,
            "link_active" => $class,
