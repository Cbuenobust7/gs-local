...
<div class='document-sign-page'>";
                ...
                if (!empty($allinvitaions)) {
                    ...
                    $small_img = ESIGN_DIRECTORY_URI . "assets/images/sign-here_blank_pdf.jpg";
                    $count = 0 ; 
                    foreach ($allinvitaions as $invite) {
                        ...
                        if ($signature_type == "typed") {
                           ...
                           $signature_css_class ="-typed" ;
                            ...
                            $sign = '<div class="sign-text-pdf" style="font-size:'. $font_size .';">
                    ...
                    $small_img2 = ESIGN_DIRECTORY_URI. "assets/images/sign-here_blank_pdf.jpg";
                ...
                if ($document->add_signature) {
                    ...
                    if ($signature_type == "typed" && $no_admin) {
                        ...
                        if (!empty($font_family)) {
                         ...
                         $signature_css_class ="-typed" ;
                        $sign_admin = '<div class="sign-text-pdf" style="font-size:'. $font_size .';">
			 ...
			 $signature_css_class ="-signed" ;			
                    ...
                    if($signature_type == "full"){
                        $small_img4 = ESIGN_DIRECTORY_URI . "assets/images/sign-here_blank_pdf_full.jpg";
                        $cssHeight = "height:110px;";
                       
                    } else {
                       $small_img4 = ESIGN_DIRECTORY_URI . "assets/images/sign-here_blank_pdf.jpg"; 
                    }
        ...
        public function document_save_as_pdf_action($more_actions, $args) {
            $doc = $args['document'];
            $pdfurl = add_query_arg(array('esigtodo' => 'esigpdf', 'did' => $doc->document_checksum), WP_E_Sig()->setting->default_link());
        ...
        private function create_pdf_document() {
           ...
           if (file_exists(WP_CONTENT_DIR . "/esign_customization/mpdf/autoload.php")) {
                ...
                require_once ( ESIG_MPDF_PATH . '/autoload.php' );
            }
            $enableDebug  = apply_filters("esig_pdf_debug",false);
            $pdf = new \Mpdf\Mpdf(["debug"=>$enableDebug,'fontdata' => esigPdfSetting::fontConfig(),"format"=>"Legal"]);
            return $pdf;
        }
