<div id="esig-access-code-verification" style="display:none" title="<?php _e('Security Verification', 'esig') ?>">
        ...
        <input type="hidden" id="esig-slv-email-address">
                ...
                <div class="tab">
                    ...
                    <div id="access_code" class="tab-content" style="display: none">
                        ...
                        <div class="slv-access-inputs">
                            <div> <label class="slv-label"><?php _e('Access Code:', 'esig'); ?></label></div>
                            <div> <input type="text" name="esig_access_code" id="esig_access_code" class="enter_access" value="" placeholder="<?php _e("Enter your access code","esig");?>"></div>
                        </div>
