    ...
    $(function ()
    {
        ...
        $("body").on("click", ".esig-sif-panel-radio ul li #addRadio", function ()
        {
            $("#radio_html").append("<li id=\"removeradio\">" +
                    ...
                    "<span class=\"esig-icon-plus\" id=\"addRadio\"></span><span class=\"esig-icon-minus\" id=\"minusRadio\"></span></span>" +
                    "</li>");
        });

        $('body').on('click','.esig-sif-panel-radio ul li #minusRadio', function ()
        {
        ...
        $("body").on("click", ".esig-sif-panel-checkbox ul li #addCheckbox", function ()
        {
            $("#checkbox_html-rupom").append("<li id=\"removecheckbox\">" +
                    ...
                    "<span class=\"esig-icon-plus\" id=\"addCheckbox\"></span><span class=\"esig-icon-minus\" id=\"minusCheckbox\"></span></span>" +
                    "</li>");
        });

        $('body').on('click',".esig-sif-panel-checkbox ul li #minusCheckbox", function ()
        {
            $(this).parent().remove();
            return false;
        });
        ...
        $("body").on("click", ".esig-sif-panel-dropdown ul li #addDropdown", function ()
        {
            $("#dropdown_html-rupom").append("<li id=\"removedropdown\">" +
                    ...
                    "<span class=\"esig-icon-plus\" id=\"addDropdown\"></span><span class=\"esig-icon-minus\" id=\"minusDropdown\"></span></span>" +
                    "</li>");
        });

        $('body').on('click',".esig-sif-panel-dropdown ul li #minusDropdown", function ()
        {
            $(this).parent().remove();
            return false;
        });
