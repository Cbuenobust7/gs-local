                                                    ...
                                                    <tr>
                                                        <td style="background-color:#ffffff;border:1px solid #ccc;padding:40px 40px 30px 40px" bgcolor="FFFFFF">
                                                            <h1 style="font-size:18px;margin:0 0 10px 0;font-weight:bold">
                                                                <?php  printf( __( 'Document Viewed: %s','esig'),$data['document_title']);?>
                                                            </h1>
                                                                <?php printf( __( 'Document ID: (%s)','esig'),$data['document_checksum']);?>
                                                                ...
                                                                <p style="line-height:1.4em;font-size:14px;margin:10px 0px">
                                                                    <?php printf( __( 'Hi %s','esig'),$data['owner_first_name'])?>,<br><br>
                                                                    <?php printf( __( "%s %s  has viewed the document. We'll let you know if they sign it. ","esig"),$data['signer_name'],$data['signer_email']);?> 
                                                                </p>
                                                                <p style="line-height:1.4em;font-size:14px;margin:10px 0px">
                                                                    <?php _e(" If you'd like more information, you can visit the documents page below.","esig") ;?>
                                                                </p>
                                                                <hr style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                                                                <div style="margin:20px 0px 20px 0px">
                                                                    <?php $background_color_bg= apply_filters('esig-invite-button-background-color','',esigget('wpUserId', $data)); $background_color = !empty( $background_color_bg) ? $background_color_bg : '#0083c5' ;  ?>
                                                                    <table cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td align="center" width="200" height="50" bgcolor="<?php echo  $background_color; ?>" style="color: #ffffff; display: block;">
                                                                                <a href="<?php echo $data['view_url']; ?>" style="font-size:14px;font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block">
                                                                                    <span style="color: #ffffff;">
                                                                                        <?php _e('View Viewed Document','esig');?>
                                                                                    </span>
                                                                                </a>
                                                                            </td>
                                                                        </tr> 
                    ...
                    <tr style="border-collapse:collapse">
                        <td style="font-family:'Helvetica Neue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse" align="center" bgcolor="#cccccc">
                            <table style="margin-top:20px" border="0" cellpadding="20" cellspacing="0" width="100%">
                                <tbody>
                                    <tr style="border-collapse:collapse">
                                        <td style="padding: 16px 12px 0px 0px;vertical-align: top;font-family: 'Helvetica Neue',Arial,Helvetica,sans-serif;font-size: 12px;line-height: 1.5em;border-collapse: collapse;color: #555;" align="left"></td>
                                        <td style="padding:0px 12px 0px 0px;vertical-align:top;font-family:'Helvetica Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555" align="left"> <br></td>                     
                                        <td style="padding:0px 0px 0px 0px;vertical-align:top;font-family:'Helvetica Neue',Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4em;border-collapse:collapse;color:#555" align="left">
                                            <a href="https://approveme.com" target="_blank">
                                                <img src="<?php echo $data['assets_dir']; ?>/images/approveme-badge.png" alt="WP E-Signature" border="0" style="width: 175px;margin-top: -8px;" class="emailClass" height="49" width="154"></a><br>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
