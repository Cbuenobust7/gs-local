...
class ESIG_ACCESS_CONTROL_Admin extends Access_Control_Setting {
    ...
    public static function Init() {
       ...
       // add_action('esig_display_right_sidebar', array(__CLASS__, 'esig_access_control_sidebar'), 10, 1);
        ...
        add_filter( 'tiny_mce_before_init', array( __CLASS__, 'filter_esig_mce_before_init' ) );
    }

    public static function filter_esig_mce_before_init(array $init){
        
         $page = esigget('post_type');
         if($page != "esign"){
             return $init;
         }
        
       $init['setup'] = "function(ed){
                    ed.on('change input', function(){ esig_setup_tinymce_content() });
            }";
         return $init;
    }
