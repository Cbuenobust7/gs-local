...
class WP_E_Shortcode {
    ...
    private function doc_signature_validates() {
        ...
        $recipient_fname = trim(esigpost('recipient_first_name'));

        $invite_hash = WP_E_Sig()->validation->esig_clean(esigpost('invite_hash'));
        $checksum = WP_E_Sig()->validation->esig_clean(esigpost('checksum'));
        ...
        if (!empty($invite_hash) && !empty($checksum)) {
            if (!esig_verify_nonce(esigpost('esig_nonce'), $invitation->document_id)) {
                wp_die('You are not allowed to sign this agreement . The validation token — a WordPress nonce — could not be verified.');
            }

            if (!esig_verify_not_spam()) {
              wp_die('You are not allowed to sign this agreement. The validation check used to prevent spam submissions has failed.');
            }
        }
    ...
    public function e_sign_document() {
        ...
        if (!ESIG_POST('recipient_signature') && !ESIG_POST('esignature_in_text')) {
                ...
                //print_r($_REQUEST);
             $wpPageType = esigget("action",$_REQUEST);
                if($wpPageType=="edit"){
                    return;
                }
            ...
            if (empty($invite_hash) || empty($checksum)) {
                ...
                if ($esigPreview) {
                    ...
                    $template_data = array(
                        "message" => sprintf(__("<p align='center' class='esig-not-found-page-template'><img src='%s/images/logo.png' alt='Sign Documents Online using WordPress E-Signature by Approve Me'></a></p><p align='center' class='esig-not-found-page-template'><strong>Woah tiger!</strong> You are attempting to access <strong>" . $document->document_title . "</strong> which was created by another user. For security reasons only the original document creator and recipients have access to this document. If you have questions about this document you can contact the document creator directly. <br>Thank you for using Wordpress Digital E-Signature By <a href='https://www.approveme.com/wp-digital-e-signature/' title='Free Document Signing by Approve Me'>Approve Me</a></p> <p align='center'><img src='%s/images/search.svg' alt='esignature by Approve Me' class='esig-not-found-search'></p>", 'esig'), $assets_dir,$assets_dir),
                    );
                } else {
                    
                    $search_img = apply_filters("esig_default_page_search_image" , sprintf(__("%s/images/search.svg","esig"),$assets_dir));
                    
                    $esig_doc_not_found_msg = sprintf(__("<p align='center' class='esig-not-found-page-template'><a href='https://www.approveme.com/wp-digital-e-signature/' title='Wordpress Digital E-Signature by Approve Me' target='_blank'><img src='%s/images/logo.png' alt='Sign Documents Online using WordPress E-Signature by Approve Me'></a></p><p align='center' class='esig-not-found-page-template'>Well this is embarrassing, but we can't seem to locate the document you're looking to sign online.<br>You may want to send an email to the website owner. <br>Thank you for using Wordpress Digital E-Signature By <a href='https://www.approveme.com/wp-digital-e-signature/' title='Free Document Signing by Approve Me'>Approve Me</a></p> <p align='center'><img src='%s' alt='esignature by Approve Me' class='esig-not-found-search'><br><a class='esig-not-found-btn' href='https://www.approveme.com/wp-digital-e-signature'>Download WP E-Signature!</a></p>", 'esig'), $assets_dir, $search_img);
                    
                    $template_data = array(
                        "message" => apply_filters("esig_document_default_message" , $esig_doc_not_found_msg)  //sprintf(__("<p align='center' class='esig-not-found-page-template'><a href='https://www.approveme.com/wp-digital-e-signature/' title='Wordpress Digital E-Signature by Approve Me' target='_blank'><img src='%s/images/logo.png' alt='Sign Documents Online using WordPress E-Signature by Approve Me'></a></p><p align='center' class='esig-not-found-page-template'>Well this is embarrassing, but we can't seem to locate the document you're looking to sign online.<br>You may want to send an email to the website owner. <br>Thank you for using Wordpress Digital E-Signature By <a href='https://www.approveme.com/wp-digital-e-signature/' title='Free Document Signing by Approve Me'>Approve Me</a></p> <p align='center'><img src='%s/images/search.svg' alt='esignature by Approve Me' class='esig-404-search'><br><a class='esig-404-btn' href='https://www.approveme.com/wp-digital-e-signature'>Download WP E-Signature!</a></p>", 'esig'), $assets_dir, $assets_dir),
                    );
                }
                    //return
            ...
            if (WP_E_Sig()->document->document_exists($document_id) == 0  || WP_E_Sig()->document->getStatus($document_id) =="trash") {
                $template_data = array(
                    "message" => sprintf(__("<p align='center' class='esig-not-found-page-template'><a href='https://www.approveme.com/wp-digital-e-signature/' title='Wordpress Digital E-Signature by Approve Me' target='_blank'><img src='%s/images/logo.png' alt='Sign Documents Online using WordPress E-Signature by Approve Me'></a></p><p align='center' class='esig-not-found-page-template'>Well this is embarrassing, but we can't seem to locate the document you're looking to sign online.<br>You may want to send an email to the website owner. <br>Thank you for using Wordpress Digital E-Signature By <a href='https://www.approveme.com/wp-digital-e-signature/' title='Free Document Signing by Approve Me'>Approve Me</a></p> <p align='center'><img src='" . $assets_dir . "/images/search.svg' alt='esignature by Approve Me' class='esig-not-found-search'><br><a class='esig-not-found-btn' href='https://www.approveme.com/wp-digital-e-signature'>Download WP E-Signature!</a></p>", 'esig'), $assets_dir),
                );
                $this->displayDocumentToSign(null, '404', $template_data);
            ...
            if ($this->doc_signature_validates()) {
                ...
                $success_msg = "<p class=\"success_title\" align=\"center\"><h2>" . $successText . "</h2> <p align='center' class='s_logo'><span class=\"esig-icon-success-check\"></span></p>";
    ...
    public function notify_signer($document, $recipient, $post, $audit_hash, $attachments = false) {
        ...
        $mailsent = WP_E_Sig()->email->send(array(
            ...
            'attachments' => $attachments,
            'document' => $document,
            'email_type' => 'signer-confirmation',
        ));
    ...
    public function get_footer_ajax() {
        ...
        $preview = WP_E_Sig()->validation->esig_clean(esigget('preview'));
        $invitecode = WP_E_Sig()->validation->esig_clean(esigget('inviteCode'));
        // If is admin
    ...
    public function displayDocumentToSign($document_id, $template, $data = array(), $return = false) {
        ...
        if ($document_id) {
            ...
            // remove the_content filter for  third party plugin conflict . 
                ...
                if (isset($data['viewer_needs_to_sign']) && $data['viewer_needs_to_sign'] && isset($data['recipient_id']) == $invite->user_id) {
                    ...
                    if ($document->document_type == "normal") {
                        ...
                        if ($invite->invite_hash != $current_user_invite_hash) { 
                            $user_data['esig-tooltip'] = 'title=" ' . __("This signature section is assigned to ", "esig") . $user_name . '"';
       ...
       // }
        ...
        if ($return_type) {
           ...
           // if (is_null($invitations)) {
            ...
            $audit_trail_data->isOverflow = ($audittrail->totalAuditEvent > 20)? true :false;
