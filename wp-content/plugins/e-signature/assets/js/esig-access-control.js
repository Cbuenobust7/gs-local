...
function resetUploadForm($) {
    ...
    $('#esig-featured-image-container').prev().show();
...
(function ($) {
    ...
    $.fn.access_role_validation = function () {
        ...
        if ($('input[name="esig_required_wpmember"]').is(":checked"))
        {
            ...
            var access_roles = $("input[name='esig_access_control_role\\[\\]']").map(function () {
