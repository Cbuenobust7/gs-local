                        ...
                        <div class="row af-inner">
                            <div class="col-sm-12">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-6 text-left"> <?php echo apply_filters("esig-signer-order-filter-temp", ""); ?> </div>
                                        <div class="col-sm-6 text-center"> <a href="#" id="addRecipient_temp"><?php _e('+ Add Signer', 'esig'); ?></a> </div>
                                    </div>
                                </div>
