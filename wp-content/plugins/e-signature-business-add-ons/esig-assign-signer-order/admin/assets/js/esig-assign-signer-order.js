(function ($) {
    ...
    $('body').on('change', '#esig-signer-edit-wrapper #esign-assign-signer-order', function (e) {
        if ($('#esig-signer-edit-wrapper #esign-assign-signer-order').is(":checked")) {
    ...
    $('body').on('change', '#esig-view-signer-add #esign-assign-signer-order', function (e) {
        ...
        if ($('#esig-view-signer-add #esign-assign-signer-order').is(":checked")) {
    ...
    $('input[name="esign-assign-signer-order-ajax"]').on('change', function () {
        ...
        if ($('input[name="esign-assign-signer-order-ajax"]').is(":checked")) {
            $.fn.signer_order_checked_view();
        } else {
            $.fn.signer_order_unchecked_view();
        }
    ...
    $('input[name="esign-assign-signer-order-temp"]').on('change', function () {
        ...
        if ($('input[name="esign-assign-signer-order-temp"]').is(":checked")) {
    ...
    $.fn.signer_order_checked = function () {
        ...
        if (esign.is_slv_active()) {
            slv = '<span id="second_layer_verification" class="esig-icon-doorkey second-layer" ></span>';
        }
        for (i = 0; i < fname.length; i++) {
            ...
            html += '<div id="signer_main" class="row">' +
                    '<div class="col-sm-1 noPadding" style="width:5% !important;"><span id="signer-sl" class="signer-sl">' + j + '.</span><span class="field_arrows"><span id="esig_signer_up"  class="up"> &nbsp; </span><span id="esig_signer_down"  class="down"> &nbsp; </span></span></div>' +
                    '<div class="col-sm-5 noPadding" style="width:39% !important;"><input class="form-control esig-input" type="text" name="recipient_fnames[]" value="' + fname[i] + '" placeholder="Signers Name" /> </div>' +
                    '<div  class="col-sm-5 noPadding leftPadding-5" style="width:39% !important;"><input type="text" class="form-control esig-input" name="recipient_emails[]" value="' + signer_name[i] + '" placeholder="email@address.com" /></div>' +
                    '<div  class="col-sm-1 noPadding text-left" style="width:14% !important;">' + delicon + '</div></div>';
    ...
    $.fn.signer_order_checked_view = function () {
        ...
        for (i = 0; i < fname.length; i++) {
            ...
            html += '<div id="signer_main" class="row">' +
                    '<div class="col-sm-1 noPadding" style="width:7% !important;"><span id="signer-sl" class="signer-sl">' + j + '.</span><span class="field_arrows"><span id="esig_signer_up"  class="up"> &nbsp; </span><span id="esig_signer_down"  class="down"> &nbsp; </span></span></div>' +
                    ...
                    '<div  class="col-sm-5 noPadding leftPadding-5" style="width:38% !important;"><input type="text" class="form-control esig-input" name="recipient_emails[]" value="' + signer_name[i] + '" placeholder="email@address.com" /></div>' +
    ...
    if ($('input[name="esign-assign-signer-order"]').is(":checked")) {
    ...
    $('#recipient_emails').bind("contentchange", function () {
        if ($('input[name="esign-assign-signer-order-view"]').is(":checked")) {
            $.fn.signer_order_checked_view();
        }
    });
