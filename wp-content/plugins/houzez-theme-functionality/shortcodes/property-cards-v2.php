...
/*	Properties
/*-----------------------------------------------------------------------------------*/
if( !function_exists('houzez_property_card_v2') ) {
	function houzez_property_card_v2($atts, $content = null)
	{
		...
		<div id="properties_module_section" class="property-cards-module property-cards-module-v2 <?php echo esc_attr($cols_class); ?>">
	...
	add_shortcode('houzez_property_card_v2', 'houzez_property_card_v2');
}
?>