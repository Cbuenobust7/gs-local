...
if( !function_exists('houzez_property_card_v3') ) {
	function houzez_property_card_v3($atts, $content = null)
	{
			...
			<div id="module_properties" class="listing-view grid-view card-deck <?php echo esc_attr($cols_class_2); ?>">
                ...
                if ( $the_query->have_posts() ) :
                    while ( $the_query->have_posts() ) : $the_query->the_post();
                        ...
                        get_template_part('template-parts/listing/item', 'v3');
	...
	add_shortcode('houzez_property_card_v3', 'houzez_property_card_v3');
}
?>