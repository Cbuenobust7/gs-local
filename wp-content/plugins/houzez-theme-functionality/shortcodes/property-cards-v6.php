...
/*	Properties
/*-----------------------------------------------------------------------------------*/
if( !function_exists('houzez_property_card_v6') ) {
	function houzez_property_card_v6($atts, $content = null)
	{
		...
		<div id="properties_module_section" class="property-cards-module property-cards-module-v1 <?php echo esc_attr($cols_class); ?>">
			<div id="module_properties" class="listing-view grid-view card-deck <?php echo esc_attr($cols_class_2); ?>">
				<?php
	...
	add_shortcode('houzez_property_card_v6', 'houzez_property_card_v6');
}
?>