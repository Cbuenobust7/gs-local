...
if( !function_exists('houzez_prop_carousel_v1') ) {
	function houzez_prop_carousel_v1($atts, $content = null)
	{
		...
		<div class="property-carousel-module houzez-carousel-arrows-<?php echo esc_attr($token); ?> houzez-carousel-cols-<?php echo esc_attr($slides_to_show); ?> property-carousel-module-v2">
	...
	add_shortcode('houzez-prop-carousel-v2', 'houzez_prop_carousel_v1');
}
?>