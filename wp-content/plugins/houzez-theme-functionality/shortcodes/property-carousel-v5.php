...
/*-----------------------------------------------------------------------------------*/
if( !function_exists('houzez_prop_carousel_v5') ) {
	function houzez_prop_carousel_v5($atts, $content = null)
	{
	...
	add_shortcode('houzez-prop-carousel-v5', 'houzez_prop_carousel_v5');
}
?>