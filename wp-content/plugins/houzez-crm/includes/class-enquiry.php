...
if ( ! class_exists( 'Houzez_Enquiry' ) ) {
	...
	class Houzez_Enquiry {
		...
		public function send_match_listing_email() {
			...
			$subject = sprintf( esc_html__('Matched Listing Email from %s', 'houzez'), get_bloginfo('name') );

	        $body = esc_html__("We found these listings against your inquiry", 'houzez')." <br/>";
