...
$tpl = aiosc_EmailManager::get_template('staff_reply');
?>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li class="active" data-screen="email-templates-staff-reply"><?php _e('New Reply','aiosc')?></li>
...
<input type="hidden" name="section" value="email-templates-staff-reply" />
