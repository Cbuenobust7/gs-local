...
$tpl = aiosc_EmailManager::get_template('staff_creation');
?>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li class="active" data-screen="email-templates-staff-creation"><?php _e('Assignment','aiosc')?></li>
...
<input type="hidden" name="section" value="email-templates-staff-creation" />
