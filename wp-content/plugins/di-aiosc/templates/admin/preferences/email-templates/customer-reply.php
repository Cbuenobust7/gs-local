...
$tpl = aiosc_EmailManager::get_template('customer_reply');
?>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li class="active" data-screen="email-templates-customer-reply"><?php _e('New Reply','aiosc')?></li>
...
<input type="hidden" name="section" value="email-templates-customer-reply" />
