...
$tpl = aiosc_EmailManager::get_template('cron_reminder_queue');
?>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        <li class="active" data-screen="email-templates-cron-reminder-queue"><?php _e('Queue','aiosc')?></li>
        <li data-screen="email-templates-cron-reminder-inactivity"><?php _e('Inactivity','aiosc')?></li>
    </ul>
</div>
<input type="hidden" name="section" value="email-templates-cron-reminder-queue" />
