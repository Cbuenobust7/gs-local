...
$tpl = aiosc_EmailManager::get_template('customer_reopen');
?>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li data-screen="email-templates-customer-closure"><?php _e('Closure','aiosc')?></li>
        <li class="active" data-screen="email-templates-customer-reopen"><?php _e('Re-Opening','aiosc')?></li>
    </ul>
</div>
<input type="hidden" name="section" value="email-templates-customer-reopen" />
