...
$tpl = aiosc_EmailManager::get_template('staff_closure');
?>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li class="active" data-screen="email-templates-staff-closure"><?php _e('Closure Request','aiosc')?></li>
        <li data-screen="email-templates-staff-reopen"><?php _e('Re-Opening','aiosc')?></li>
    </ul>
</div>
<input type="hidden" name="section" value="email-templates-staff-closure" />
