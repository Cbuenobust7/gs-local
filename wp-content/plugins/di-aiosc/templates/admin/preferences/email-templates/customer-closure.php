...
$tpl = aiosc_EmailManager::get_template('customer_closure');
?>
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        <li class="active" data-screen="email-templates-customer-creation"><?php _e('Customers','aiosc')?></li>
        <li data-screen="email-templates-staff-creation"><?php _e('Staff','aiosc')?></li>
...
<div class="aiosc-subtoolbar">
    <ul class="aiosc-subtabs">
        ...
        <li data-screen="email-templates-customer-creation"><?php _e('Creation','aiosc')?></li>
        <li data-screen="email-templates-customer-reply"><?php _e('New Reply','aiosc')?></li>
        <li class="active" data-screen="email-templates-customer-closure"><?php _e('Closure','aiosc')?></li>
        <li data-screen="email-templates-customer-reopen"><?php _e('Re-Opening','aiosc')?></li>
    </ul>
</div>
<input type="hidden" name="section" value="email-templates-customer-closure" />
