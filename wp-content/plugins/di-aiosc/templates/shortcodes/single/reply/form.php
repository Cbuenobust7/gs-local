...
<div class="aiosc-window aiosc-reply-form">
    <h2 class="aiosc-title aiosc-title-sm"><?php _e('Post new Reply','aiosc') ?></h2>
    <div class="aiosc-separator"></div>
    <div id="aiosc-reply-response" class="aiosc-form-response"></div>
    ...
    <div class="aiosc-loading-holder">
        <div class="aiosc-loading-bar">
            <span><?php _e('Posting reply...','aiosc')?></span>
        </div>
    </div>
    <div class="aiosc-separator"></div>
</div>
