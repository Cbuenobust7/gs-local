					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<div class="form-group">
								...
								<input class="form-control" name="floor_plans[<?php echo intval($count); ?>][fave_plan_title]" value="<?php echo sanitize_text_field( $plan_title ); ?>" type="text">
							</div>
						...
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control" name="floor_plans[<?php echo intval($count); ?>][fave_plan_rooms]" value="<?php echo sanitize_text_field( $plan_rooms ); ?>" type="text">
							</div>
						</div><!-- col-md-6 col-sm-12 -->
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								<label for="floor_plans[<?php echo intval($count); ?>][fave_plan_bathrooms]"><?php echo houzez_option('cl_plan_bathrooms', 'Bathrooms' ); ?></label>
			                    <input value="<?php echo sanitize_text_field( $plan_bathrooms ); ?>" name="floor_plans[<?php echo intval($count); ?>][fave_plan_bathrooms]" type="text" id="fave_plan_bathrooms_0" class="form-control">
							</div>
						</div><!-- col-md-6 col-sm-12 -->
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								<label for="floor_plans[<?php echo intval($count); ?>][fave_plan_price]"><?php echo houzez_option('cl_plan_price', 'Price' ); ?></label>
			                    <input value="<?php echo sanitize_text_field( $price ); ?>" name="floor_plans[<?php echo intval($count); ?>][fave_plan_price]" type="text" id="fave_plan_price_0" class="form-control">
							</div>
						</div><!-- col-md-6 col-sm-12 -->
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
			                    ...
			                    <input value="<?php echo sanitize_text_field( $price_postfix ); ?>" name="floor_plans[<?php echo intval($count); ?>][fave_plan_price_postfix]" type="text" id="fave_plan_price_postfix_0" class="form-control">
							</div>
						</div><!-- col-md-6 col-sm-12 -->
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								<label for="floor_plans[<?php echo intval($count); ?>][fave_plan_size]"><?php echo houzez_option('cl_plan_size', 'Plan Size' ); ?></label>
			                    <input value="<?php echo sanitize_text_field( $plan_size ); ?>" name="floor_plans[<?php echo intval($count); ?>][fave_plan_size]" type="text" id="fave_plan_size_0" class="form-control">
							</div>
						</div><!-- col-md-6 col-sm-12 -->
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group">
			                    ...
			                    <textarea name="floor_plans[<?php echo intval($count); ?>][fave_plan_description]" rows="4" id="fave_plan_description_0" class="form-control"><?php echo sanitize_textarea_field($fave_plan_description); ?></textarea>
							</div>
			...
			<div class="houzez-floorplan-clone">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						...
						<div class="form-group">
							<label><?php echo houzez_option('cl_plan_title', 'Plan Title' ); ?></label>
							<input class="form-control" name="floor_plans[0][fave_plan_title]" placeholder="" type="text">
						</div>
					</div><!-- col-md-6 col-sm-12 -->
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
							<label><?php echo houzez_option('cl_plan_bedrooms', 'Bedrooms' ); ?></label>
							<input class="form-control" name="floor_plans[0][fave_plan_rooms]" placeholder="" type="text">
						</div>
					</div><!-- col-md-6 col-sm-12 -->
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
