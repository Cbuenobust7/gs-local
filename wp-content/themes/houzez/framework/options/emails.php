...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'subtitle' => esc_html__('Use %sender_name , %sender_email , %sender_phone , %website_name , %property_title , %property_link , %schedule_date , %schedule_time ,  %sender_message', 'houzez'),
            'desc'   => ''
        ),
        array(
