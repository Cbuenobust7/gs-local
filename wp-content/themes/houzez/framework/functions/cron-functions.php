        ...
        if($prop_selection->have_posts()){
            ...
            while ($prop_selection->have_posts()): $prop_selection->the_post();
                ...
                if( !empty( $prop_bed ) ) {
                    ...
                    $beds = '<span class="item-amenities-text">'.$prop_bed_lebel.':</span> <span>'.$prop_bed.'</span>';
                }
                if( !empty( $prop_bath ) ) {
                    $prop_bath = esc_attr( $prop_bath );
                    $prop_bath_label = ($prop_bath > 1 ) ? houzez_option('glc_baths', 'Baths') : houzez_option('glc_bath', 'Bath');

                    $baths = '<span class="item-amenities-text">'.$prop_bath_lebel.':</span> <span>'.$prop_bath.'</span>';
                }
                ...
                $mail_content .= '<tr>
                    <td>
                        <a href="'.get_permalink().'">
                            <img class="img-fluid" src="'.$thumbnail[0].'" alt="">
                        </a> 
                    </td>
                    <td>
                        <a class="item-title" href="'.get_permalink().'"><strong>'.get_the_title().'</strong></a> 
                        <ul class="item-price-wrap">
                            <li>
                                <span class="price-prefix">'.$price_prefix.' '.houzez_get_property_price($sale_price).'</span>
                            </li>
                            <li>'.houzez_taxonomy_simple('property_status').'</li>
                        </ul>               
                        <ul class="item-amenities">
                            ...
                            <li>
                                <span>'.houzez_taxonomy_simple('property_type').'</span>
                            </li>
                        </ul>
                        <a class="btn" href="'.get_permalink().'">'.esc_html__('View Details', 'houzez').'</a>
                    </td>
                </tr>';
